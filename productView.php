...
<head>
    ...
    <title>View Product Details | e-Commerce Portal</title>
...
<body>
    ...
    <div class="container">
        <?php 
        $sqlMain = "SELECT p.pcm_id, m.pcm_name FROM product_details p JOIN p_category_main m ON m.pcm_id = p.pcm_id GROUP BY (p.pcm_id)";
